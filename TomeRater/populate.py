...
novel1 = Tome_Rater.create_novel("Alice In Wonderland", "Lewis Carroll", 12345, 25)
novel1.set_isbn(9781536831139)
nonfiction1 = Tome_Rater.create_non_fiction("Automate the Boring Stuff", "Python", "beginner", 1929452, 30)
nonfiction2 = Tome_Rater.create_non_fiction("Computing Machinery and Intelligence", "AI", "advanced", 11111938, 42)
novel2 = Tome_Rater.create_novel("The Diamond Age", "Neal Stephenson", 10101010, 20)
